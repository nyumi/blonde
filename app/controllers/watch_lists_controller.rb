...
# 作者とタイトル等の情報
    p "-------------------"
    # p doc.at_css('.a-unordered-list.a-nostyle.a-button-list,a-horizontal > .a-button-inner > a')
    p doc.at_css(".a-button.a-spacing-mini.a-button-toggle.format > .a-button-inner > a")['href']
...
#     p "------------------"
# ワンピKindleのリンク
    kurl = "https://www.amazon.co.jp" +
            doc.at_css('.a-button.a-spacing-mini.a-button-toggle.format > .a-button-inner > a')['href']
    # p kurl
